    ...
    public partial class FrmBackup : Form
    {
        ...
        private void Btn_Aceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SaveDialogo.InitialDirectory = Concesionarias.Properties.Settings.Default.UltimaRutaGuardarBackup;
                SaveDialogo.OverwritePrompt = true;
                SaveDialogo.Title = "Guardar backup de base de datos.";
                SaveDialogo.ShowDialog();

                Concesionarias.Properties.Settings.Default.UltimaRutaGuardarBackup = SaveDialogo.FileName.Substring(0, SaveDialogo.FileName.LastIndexOf(@"\"));
                ...
                Concesionarias.Properties.Settings.Default.Save();
                Close();
            }
            catch
            {
        ...
        private void Btn_Restablecer_Click(object sender, EventArgs e)
        {
            ...
            OpenDialogo.InitialDirectory = Concesionarias.Properties.Settings.Default.UltimaRutaGuardarBackup;
